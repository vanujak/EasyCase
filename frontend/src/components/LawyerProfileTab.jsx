...
export default function LawyerProfileTab() {
  ...
  return (
    <div className="p-6 max-w-xl">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900">Lawyer Credentials</h2>
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-black"
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            disabled
            className="w-full rounded-lg border border-gray-200 bg-gray-100 px-3.5 py-2 text-sm text-gray-500 cursor-not-allowed"
          />
          <p className="text-xs text-gray-400 mt-1">Managed via Clerk Profile tab</p>
        </div>
        ...
        <div>
          ...
          <select
            ...
            value={form.gender}
            onChange={onChange}
            className="w-full rounded-lg border border-gray-300 px-3.5 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-black"
            required
          >
        ...
        <div className="pt-3">
          <button
            type="submit"
            disabled={loading}
            className="px-5 py-2.5 rounded-lg bg-black text-white text-sm font-semibold hover:bg-gray-800 transition disabled:opacity-50 flex items-center gap-2"
          >
